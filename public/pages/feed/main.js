...
export const feed = () => {
  ...
  <div class='textarea-location'>Localização: <img class='size' src='../../assets/pin.png'>
  <textarea id='location' class='personal-info' type='text' data-id=${user.id} disabled>${user.location}</textarea></div>  
  </fieldset>
  ...
  postBtn.addEventListener('click', (event, post) => {
    event.preventDefault();
    if (inputPost.value === ''){
